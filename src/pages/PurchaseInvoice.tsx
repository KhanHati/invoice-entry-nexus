      ...
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            {formData.billType === 'including-tax-vat' && <div className="space-y-4 border-t pt-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="number" value={formData.totalVAT} onChange={e => handleInputChange('totalVAT', parseFloat(e.target.value) || 0)} placeholder="Enter total VAT" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="totalTP">Total TP</Label>
                    <Input type="number" value={totalTP} readOnly className="bg-gray-100" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="totalTAX">Total TAX</Label>
                    <Input type="number" value={totalTAX.toFixed(2)} readOnly className="bg-gray-100" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input type="number" value={formData.totalDiscount} onChange={e => handleInputChange('totalDiscount', parseFloat(e.target.value) || 0)} placeholder="Enter discount" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="payableToVendor">Payable to Vendor</Label>
                    <Input type="number" value={payableToVendor.toFixed(2)} readOnly className="bg-gray-100" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="totalTDSVDS">Total TDS & VDS</Label>
                    <Input type="number" value={totalTDSVDS.toFixed(2)} readOnly className="bg-gray-100" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea value={formData.note} onChange={e => handleInputChange('note', e.target.value)} placeholder="Enter notes" rows={3} />
                  </div>
                </div>
              </div>}
          </CardContent>
        ...
        {formData.billType === 'including-tax-vat' && <>
            ...
            {products.length > 0 && <>
                ...
                <PurchaseSummary formData={formData} products={products} calculatedValues={{
            totalTP,
            totalTAX,
            payableToVendor,
            totalTDSVDS
